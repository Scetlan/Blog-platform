...
import classes from './ModalDeleted.module.scss';

export default function ModalDeleted({ onClickDeleteYes, onClickDeleteNo }) {
  return (
    <div className={classes['modal-deleted']}>
      <div className={classes['modal-desc']}>
        ...
        <p className={classes['modal-text']}>Are you sure to delete this article?</p>
      </div>
      <div className={classes['approval-buttons']}>
        <button type="button" className={classNames(classes['blog-btn'], classes['no-btn'])} onClick={onClickDeleteNo}>
          No
        </button>
        <button
          type="button"
          className={classNames(classes['blog-btn'], classes['yes-btn'])}
